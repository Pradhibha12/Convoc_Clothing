...
class VendorController extends Controller
{
    ...
    function product_add()
    {
        ...
        if ($referer && str_contains($referer, route('vendor.products'))) {
    ...
    function product_store(Request $request, $action_type = '')
    {
        ...
        $referrer = session('product_add_referrer') ?? route('vendor.products');
    ...
    function product_update(Request $request, $id)
    {
        ...
        $referrer = session('product_edit_referrer') ?? route('vendor.products');
