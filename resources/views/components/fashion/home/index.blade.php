            ...
            <div class="col-12">
                <div class="home-hero-inner-wrap">
                    ...
                    <div class="home-hero-banner position-relative mx-auto">
                        <img class="d-none d-lg-block banner" src="{{ asset('assets/frontend/fashion/images/images/fashion-banner-clean-hd-v3.webp') }}?v={{ time() }}" alt="banner">
                        <img class="d-block d-lg-none banner" src="{{ asset('assets/frontend/fashion/images/images/fashion-banner-md-clean.png') }}?v={{ time() }}" alt="banner">
                        
                        <!-- Clean HD Typography Overlay for Desktop -->
                        <div class="d-none d-lg-block" style="position: absolute; left: 8%; top: 16%; z-index: 5; text-align: left; max-width: 520px; pointer-events: none;">
                        ...
                        <a href="{{route('all_products')}}" class="btn fsh-btn-dark pe-4 icon-right" style="position: absolute; left: 8%; top: 70%; z-index: 10; padding: 12px 24px; font-size: 14px; font-weight: 600; text-transform: none;">
                        ...
                        <div class="explore-artworks-btn d-none d-lg-block" style="position: absolute; left: 24%; top: 66.5%; width: 10.0%; height: 14.1%; z-index: 12; pointer-events: none;">
