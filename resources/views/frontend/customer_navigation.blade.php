            ...
            <div class="mb-10px">
                ...
                <nav>
                    <ul class="sidebar-nav-ul">
                        ...
                        <li class="sidebar-nav-item"><a href="{{ route('order.track') }}" class="sidebar-nav-link @if($current_route == 'order.track') active @endif">
                            <span class="d-flex align-items-start gap-6px">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#99A1B7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin">
                                    <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/>
                                    <circle cx="12" cy="10" r="3"/>
                                </svg>
                                <span class="mt-2px">{{ get_phrase('Track Order') }}</span>
                            </span>                                               
                        </a></li>
