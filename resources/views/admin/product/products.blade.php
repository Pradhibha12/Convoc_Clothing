                ...
                <div class="col-lg-7 mb-2 d-flex flex-wrap align-items-center gap-3">
                    ...
                    @php
                        ...
                        if (request()->filled('store') && request('store') != 'all') {
                            $st = App\Models\Store::where('slug', request('store'))->first();
                            $active_filters[] = [
                                'label' => get_phrase('Store'),
                                'value' => $st ? $st->name : request('store'),
                                'key' => 'store'
                            ];
                        }
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center ms-2">
                            @foreach ($active_filters as $filter)
                                @php
                                    ...
                                    $removeUrl = route('admin.products', $params);
                                @endphp
                            ...
                            @endforeach
                            <a href="{{ route('admin.products') }}" class="btn btn-sm btn-outline-danger py-1 px-2 rounded-pill fs-11px" data-bs-toggle="tooltip" title="{{ get_phrase('Clear All Filters') }}">
                                ...
                                <tr class="hidden-btn">
                                    ...
                                    <td>
                                        <div class="print-d-none d-flex flex-wrap align-items-center gap-2 row-gap-2">
                                            ...
                                            <a href="{{ route('admin.product.duplicate', ['id' => $product->id]) }}" data-bs-toggle="tooltip" title="{{ get_phrase('Duplicate') }}" class="btn btn-secondary-light btn-icon"><i class="fi-rr-copy"></i></a>
