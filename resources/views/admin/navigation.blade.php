...
<div class="sidebar-nav-area">
    ...
    <nav class="sidebar-nav">
        ...
        <ul class="px-14px pb-24px pb-5 mb-5">
            <li class="sidebar-first-li first-li-have-sub {{ $current_route == 'admin.system.settings' || $current_route == 'admin.website.settings' || $current_route == 'admin.menu.settings' || $current_route == 'admin.footer.settings' || $current_route == 'admin.settings' || $current_route == 'admin.smtp.settings' || $current_route == 'admin.payment.settings' || $current_route == 'admin.seo.settings' || $current_route == 'admin.about' || $current_route == 'admin.pages' || $current_route == 'admin.page.add' || $current_route == 'admin.page.edit' || $current_route == 'admin.languages' || $current_route == 'admin.language.edit' || $current_route == 'admin.themes' || $current_route == 'admin.theme.edit' || $current_route == 'admin.language.phrases.edit' ? 'active' : '' }}">
                <a href="javascript:void(0);">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li {{ $current_route == 'admin.menu.settings' ? 'active' : '' }}">
                        <a href="{{ route('admin.menu.settings') }}">{{ get_phrase('Header Menu Manager') }}</a>
                    </li>
                    <li class="sidebar-second-li {{ $current_route == 'admin.footer.settings' ? 'active' : '' }}">
                        <a href="{{ route('admin.footer.settings') }}">{{ get_phrase('Footer Settings') }}</a>
                    </li>
