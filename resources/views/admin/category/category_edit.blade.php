            ...
            <div class="ol-card p-4">
                <div class="ol-card-body">
                    <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="sort" class="form-label ol-form-label">{{get_phrase('Sort Order (Serial Number)')}}</label>
                            <input type="number" value="{{ $category->sort ?? 0 }}" name="sort" class="form-control ol-form-control" id="sort" placeholder="{{get_phrase('e.g. 1, 2, 3')}}" min="0">
                        </div>
