...
Route::prefix('admin/')->name('admin.')->middleware(['auth', AdminMiddleware::class])->controller(AdminController::class)->group(function () {
    ...
    Route::get('product/duplicate/{id}', 'product_duplicate')->name('product.duplicate');
    Route::get('product-image-delete/{id}', 'product_image_delete')->name('product.image.delete');
    Route::get('product-banner-delete/{id}', 'product_banner_delete')->name('product.banner.delete');
    ...
    Route::get('menu-settings', 'menu_settings')->name('menu.settings');
    Route::post('menu-settings/update', 'menu_settings_update')->name('menu.settings.update');
    Route::get('footer-settings', 'footer_settings')->name('footer.settings');
    Route::post('footer-settings/update', 'footer_settings_update')->name('footer.settings.update');
